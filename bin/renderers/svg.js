...
var SVGRenderer = function () {
	...
	_createClass(SVGRenderer, [{
		...
		key: "drawSVGDelimiter",
		value: function drawSVGDelimiter(parent, options, encoding) {
			var lineElem = this.document.createElementNS(svgns, 'line');
			// Draw the text if displayValue is set
			if (options.displayValueDelimiter) {
				var x, y;

				lineElem.setAttribute("style", "stroke:" + options.lineColor + "; stroke-width: " + options.displayValueDelimiterWidth);
